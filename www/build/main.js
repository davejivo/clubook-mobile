...
var LoginPage = (function () {
    ...
    LoginPage.prototype.login = function (loginUser) {
        ...
        this.restProvider.login(loginUser.user, loginUser.password)
            ...
            _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_3__cards_cards__["a" /* CardsPage */], { token: _this.token });
        });
    };
...
var CardsPage = (function () {
    ...
    CardsPage.prototype.chooseCard = function (index) {
        var card = document.getElementById('card' + index);
        var cardTitle = document.getElementById('cardTitle' + index);
